...
import doraIcon from '@/images/logos/dora.svg'
...
const projects = [
  {
    name: 'DORA',
    description:
      'EU:s förordning om digital operativ motståndskraft för finansiella entiteter. En sajt jag skapat tillsammans med mina kollegor.',
    link: {
      href: 'https://www.dora.nu',
      label: 'dora.nu',
    },
    logo: doraIcon,
    published: true,
